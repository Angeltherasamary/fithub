...
import { fetchMock } from "../../components/services/utils/apiMock.js";
const ExerciseDetail = () => {
  ...
  useEffect(() => {
    ...
    const fetchExercisesData = async () => {
      ...
      const exerciseDetailData = await fetchMock(`/api/exercises?id=${id}`)
      ...
      const targetMuscleExercisesData = await fetchMock(
      ...
      const equimentExercisesData = await fetchMock(
